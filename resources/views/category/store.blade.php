        ...
        <div class="categories-container">
            ...
            <div class="card mb-3 col-lg-5 col-md-6 col-sm-9 px-0">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('category.save') }}" class="add-category d-flex align-items-start">
            ...
            <ul class="list-group">
                @foreach ($categories as $category)
                    <li class="list-group-item">
                        ...
                        <form class="edit-category-form {{ $errors->has('name_'.$category->id) ? 'd-block' : 'd-none' }}"
                            ...
                            <div class="form-container d-flex justify-content-between align-items-center">
                                <div class="form-group mb-0 col-lg-3 col-md-4 col-sm-6 px-0">
                                    ...
                                    <input id="name" name="name_{{ $category->id }}" 
                                        ...
                                        class="form-control {{ $errors->has('name_'.$category->id) ? 'is-invalid' : '' }}">
